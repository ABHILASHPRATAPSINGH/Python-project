...
from src.userform.Png2PdfFrame import Png2PdfFrame

class Png2PdfFrameEx(Png2PdfFrame):
    ...
    def __init__(self):
        ...
        super(Png2PdfFrameEx, self).__init__()
        ...
        self.framePngList.setStyleSheet(previewWidgetStyle)
        self.framePngPreview.setStyleSheet(previewWidgetStyle)
        self.framePngControls.setStyleSheet(previewWidgetStyle)

        self._lblPreviewHeading.setStyleSheet(previewWidgetStyle)
        self._lblFileListHeading.setStyleSheet(previewWidgetStyle)

        self._imageWidget=ImageArViewerWidget()
        self._imageWidget.setContentsMargins(0,0,0,3)
        self._imageWidget.setStyleSheet(previewWidgetStyle)
