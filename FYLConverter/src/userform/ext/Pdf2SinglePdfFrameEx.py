...
from src.userform.Pdf2SinglePdfFrame import Pdf2SinglePdfFrame
from src.userform.ext.FilePathSelectionWidgetEx import FilePathSelectionWidgetEx


class Pdf2SinglePdfFrameEx(Pdf2SinglePdfFrame):

    def __init__(self):
        super(Pdf2SinglePdfFrameEx, self).__init__()
        ...
        titleStyle=FYLStyleSheet.getStyleTitleFrame()
        self.titleFrame.setStyleSheet(titleStyle)

        bodyFrameStyle=FYLStyleSheet.getStyleBodyFrame2()
        self.bodyFrame.setStyleSheet(bodyFrameStyle)

        bottomFrameStyle=FYLStyleSheet.getStyleBottomBodyFrame2()
