...
# Form implementation generated from reading ui file 'Pdf2SeperatePdfFrame.ui'
#
...
"")
        ...
        self._lblFrameIcon.setPixmap(QtGui.QPixmap(":/resources/images/resources/images/pdf2pdf2.png"))
...
"")
        ...
        self._btnExport2SeperatePdf = QtWidgets.QPushButton(self.bottomFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self._btnExport2SeperatePdf.sizePolicy().hasHeightForWidth())
        self._btnExport2SeperatePdf.setSizePolicy(sizePolicy)
        self._btnExport2SeperatePdf.setMinimumSize(QtCore.QSize(120, 40))
        self._btnExport2SeperatePdf.setMaximumSize(QtCore.QSize(150, 60))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/resources/images/resources/images/export.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self._btnExport2SeperatePdf.setIcon(icon)
        self._btnExport2SeperatePdf.setIconSize(QtCore.QSize(16, 16))
        self._btnExport2SeperatePdf.setObjectName("_btnExport2SeperatePdf")
        self.horizontalLayout_13.addWidget(self._btnExport2SeperatePdf)
    ...
    def retranslateUi(self, Frame):
        ...
        self._lblFrameTitle.setText(_translate("Frame", "Export Selected PDF Pages to Separate PDF File"))
        ...
        self._btnExport2SeperatePdf.setText(_translate("Frame", "Export"))
