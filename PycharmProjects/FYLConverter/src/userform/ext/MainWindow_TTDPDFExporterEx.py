...
from src.userform.MainWindow_TTDPDFExporter import MainWindow_TTDPDFExporter
...
class MainWindow_TTDPDFExporterEx(MainWindow_TTDPDFExporter):
    def __init__(self,
                windowTitle: str = "TTD PDF Exporter",
        ...
        super(MainWindow_TTDPDFExporterEx, self).__init__()
        ...
        self._frameHome=HomeFrame_PDFExporterEx()
...
if __name__ == '__main__':
    ...
    win=MainWindow_TTDPDFExporterEx()
    win.show()
    app.exec()
